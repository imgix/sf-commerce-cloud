...
module.exports.init = function (editor) {
    ...
    var localization = Object.keys(defaults).reduce(function (acc, key) {
        acc.put(key, Resource.msg(key, 'experience.editors.imgix.imgixEditorTrigger', defaults[key]));
        return acc;
    }, new HashMap());
    ...
    var breakoutEditor = PageMgr.getCustomEditor('imgix.imgixEditorTriggerBreakout', breakoutEditorConfig);
