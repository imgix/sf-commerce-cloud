'use strict';
/**
 * Commerce Cloud plugin to document controller-based script code.
 */
	...
	if (p.type && p.type.names) {
		...
		for (var j = 0; j < names.length; j++) {
			...
			if (name.indexOf('dw.') === 0 || ['Object', 'String', 'Array', 'Boolean', 'Date', 'Number', 'XML', 'RegExp'].indexOf(name) > -1) {
				...
				helper.registerLink(name, 'https://documentation.demandware.com/DOC2/topic/com.demandware.dochelp/DWAPI/scriptapi/html/api/class_' + urlName + '.html');
			}
		}
	}
};
